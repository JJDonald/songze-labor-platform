import { HomePage, AchievementsPage, ProfilePage, SubmitPage, CoursesPage, AdminDashboard, AdminUsers, AdminCourses, AdminAchievements, AdminEvaluationDimensions } from '@/pages';
